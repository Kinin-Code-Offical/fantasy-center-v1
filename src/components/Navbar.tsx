...
export default function Navbar() {
    ...
    return (
        <nav className="border-b border-white/10 bg-[#0a0a12]/95 md:bg-[#0a0a12]/80 md:backdrop-blur-xl sticky top-0 z-50 shadow-[0_0_20px_rgba(188,19,254,0.1)]">
            ...
            {isMobileMenuOpen && session && (
                <div className="md:hidden absolute top-20 left-0 w-full bg-[#0a0a12]/95 backdrop-blur-xl border-b border-white/10 shadow-2xl animate-in slide-in-from-top-5 duration-200 z-40">
