                        ...
                        <div className="flex-1 overflow-y-auto p-2 custom-scrollbar">
                            <div className="grid grid-cols-1 gap-2">
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 p-3 border-l-2 transition-all duration-200 text-left relative overflow-hidden ${
                                        selectedPlayerId === ""
                                ...
                                {filteredPlayers.map(p => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 p-3 border-l-2 transition-all duration-200 text-left group relative overflow-hidden ${
                    ...
                    <div className="max-w-sm mx-auto w-full space-y-8 relative z-10">
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div className="relative py-4">
                                <div className={`text-5xl md:text-6xl font-black tracking-tighter font-mono relative z-10 ${
                                    tradeAnalytics.netValue > 0 ? "text-neon-green drop-shadow-[0_0_10px_rgba(0,255,65,0.5)]" : "text-red-500 drop-shadow-[0_0_10px_rgba(239,68,68,0.5)]"
                                }`}>
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-neon-green text-black font-black text-lg uppercase tracking-widest hover:bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group clip-path-button"
                        ...
                        >
                            ...
                            <div className="relative flex items-center justify-center gap-3">
                                {isSubmitting ? (
                                    ...
                                    <>
                                        <Lock className="w-5 h-5" /> EXECUTE TRADE PROTOCOL
                                    </>
                                )}
                            </div>
                        </button>
